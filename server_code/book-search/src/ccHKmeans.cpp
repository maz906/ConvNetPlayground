...
DistanceType getDistanceType(int type)
{
  ...
  if (type==0)            dt = DISTANCE_L1;
  else if (type==1)       dt = DISTANCE_L2;
  else if (type==2)  dt = DISTANCE_HAMMING;
  else if (type==3)      dt = DISTANCE_COS;
  else if (type==4)   dt = DISTANCE_ARCCOS;
  else if (type==5)     dt = DISTANCE_BHAT;
  else if (type==6)       dt = DISTANCE_KL;
  else if (type==7)      dt = DISTANCE_JAC;
  else if (type==8)      dt = DISTANCE_XOR;
  else cout<<"Unknown distance function."<<endl;
